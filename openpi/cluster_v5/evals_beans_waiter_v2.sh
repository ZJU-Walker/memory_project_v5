#!/usr/bin/env bash
# (v2, 2026-09-06: A9/B9 dated 20260906, EXP_DATE override; MANIFEST/GPU/GRES/NO_PLACEHOLDER pass through the env to the runner.)
...
for stage in $STAGES; do
  cfg=pi05_yam_mem_v5_beans$stage; exp=v5_beans${stage}_${EXP_DATE:-$( case "$stage" in A9|B9) echo 20260906;; A4|B4|A5|B5|B5d1|A6|B6|A7|B7|A6d1|B6d1|A6sd|B6sd|A6sep|B6sep|A8|B8) echo 20260905;; *) echo 20260904;; esac )}_r1
