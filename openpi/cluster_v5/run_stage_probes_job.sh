...
step "tray probe ${STAGE}_keep_299 development" scripts/v5_tray_flip_eval.py $diag/tray_flip_${STAGE}_keep_299_development --split development --alphas 0.01,0.0 --batches 24
...
step "tray probe ${STAGE}_keep_299 train" scripts/v5_tray_flip_eval.py $diag/tray_flip_${STAGE}_keep_299_train --split train --alphas 0.01,0.0 --batches 24
